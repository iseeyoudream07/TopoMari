...
const messages = {
  "zh-CN": {
    ...
    "general.title": "通用设置",
    "general.descriptionHelp": "选择公开面板的视觉主题、配色和自动日夜模式。",
  ...
  en: {
    ...
    "general.descriptionHelp": "Choose the public dashboard's visual theme, colors, and automatic day/night behavior.",
