...
const messages = {
  "zh-CN": {
    "brand.kicker": "网络拓扑可观测性",
    "brand.defaultSubtitle": "多跳延迟、丢包与链路健康状态",
    ...
    "stats.loss": "平均丢包",
    "stats.waiting": "等待数据",
    "stats.acrossEdges": "所有已配置链路段",
    "stats.historyWindow": "当前历史统计窗口",
    "stats.measuredEdges": "{count} 个监测链路段",
    "stats.allNodesOnline": "所有已配置节点均在线",
    "stats.nodesOffline": "{count} 个节点离线",
    "topology.kicker": "实时路径矩阵",
    "topology.title": "链路拓扑",
    "topology.subtitle": "端到端网络连通性",
    "topology.awaiting": "等待首个数据快照",
    "topology.aria": "网络概览",
    "manager.kicker": "链路编排",
    "manager.title": "链路管理器",
    "manager.subtitle": "本地 → 中转 → 落地 → 国际网络",
    "manager.close": "关闭",
    "manager.routes": "链路列表",
    "manager.routesHelp": "选择一条链路进行编辑",
    ...
    "deploy.copied": "已复制",
    "agents.title": "已注册探针",
    "agents.help": "状态每 10 秒刷新；停用后该 Agent 将无法提交样本",
    "analysis.kicker": "链路分析",
    "analysis.title": "链路健康",
    "analysis.legend": "最新 / 平均 / 丢包",
    "nodes.kicker": "节点状态",
    "nodes.title": "受监测节点",
    "error.title": "无法载入面板数据",
    "footer.text": "TopoMari · 自托管网络拓扑监测",
    "status.healthy": "健康",
    "status.warning": "关注",
    "status.degraded": "异常",
    "status.failed": "失败",
  ...
  en: {
    "brand.kicker": "NETWORK TOPOLOGY OBSERVABILITY",
    "brand.defaultSubtitle": "Multi-hop latency, packet loss, and route health",
    ...
    "stats.acrossEdges": "Across configured links",
    "stats.historyWindow": "Current history window",
    ...
    "topology.kicker": "LIVE PATH MATRIX",
    "topology.title": "Routing topology",
    "topology.subtitle": "End-to-end network connectivity",
    "topology.awaiting": "Awaiting first snapshot",
    "topology.aria": "Network overview",
    "manager.kicker": "ROUTE ORCHESTRATION",
    "manager.title": "Route manager",
    "manager.subtitle": "Local → Relay → Exit → Internet",
    "manager.close": "Close",
    "manager.routes": "Route list",
    "manager.routesHelp": "Select a route to edit",
    ...
    "agents.help": "Status refreshes every 10 seconds; disabled Agents cannot submit samples",
    "analysis.kicker": "EDGE ANALYSIS",
    "analysis.title": "Link health",
    "analysis.legend": "Latest / average / loss",
    "nodes.kicker": "NODE STATUS",
    "nodes.title": "Monitored nodes",
    "error.title": "Unable to load dashboard data",
    "footer.text": "TopoMari · Self-hosted network topology monitoring",
