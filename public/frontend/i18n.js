...
const messages = {
  "zh-CN": {
    ...
    "admin.loginTitle": "登录后台管理",
    "admin.loginDescription": "公开面板无需登录；只有链路和站点设置需要管理员身份。",
    "admin.username": "用户名",
    "admin.password": "密码",
    "admin.login": "登录",
    "admin.loginFailed": "登录失败",
    "admin.backHome": "返回公开面板",
    "admin.routes": "链路管理",
    "admin.settings": "设置",
    "admin.site": "站点",
  ...
  en: {
    ...
    "admin.loginTitle": "Sign in to admin",
    "admin.loginDescription": "The public dashboard needs no sign-in; only routes and site settings require an administrator.",
    "admin.username": "Username",
    "admin.password": "Password",
    "admin.login": "Sign in",
    "admin.loginFailed": "Sign-in failed",
    "admin.backHome": "Back to public dashboard",
