...
const messages = {
  "zh-CN": {
    ...
    "themeSettings.description": "精细调整公开面板的背景媒体、毛玻璃强度、边框和圆角；主题样式仍在“设置 → 通用”中切换。",
  ...
  en: {
    ...
    "themeSettings.description": "Fine-tune public dashboard backgrounds, glass strength, borders, and corners. Select the theme style under Settings → General.",
